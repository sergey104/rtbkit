    ...
    void setConfig()
    {
        ...
        config.providerConfig["appodeal"]["iurl"] = "http://www.gnu.org";
                ...
                for(auto & c: config.creatives){
                    ...
                    c.providerConfig["appodeal"]["nurl"] = "http://52.208.150.10:17340?winprice=${AUCTION_PRICE}&auction_id=d2a3a24d-7c0b-4805-9317-19f1783ceb101468775636296&adspot_id=0";
