/** appodeal_exchange_connector_test.cc                                 -*- C++ -*-
    S.F. 24.05.2016
*/
...
#include "rtbkit/plugins/exchange/appodeal_exchange_connector.h"
#include "rtbkit/core/router/router.h"


using namespace RTBKIT;

const std::string bid_sample_filename("/home/fil/rtbkit/rtbkit/plugins/exchange/testing/appodealtestrequest.json");
...
BOOST_AUTO_TEST_CASE( test_openrtb_error_codes )
{
    ...
    auto connector = std::make_shared<AppodealExchangeConnector>("connector", proxies);
    ...
    BOOST_CHECK(validateJsonQuery("",strJson.c_str()));
    router.shutdown();
}
