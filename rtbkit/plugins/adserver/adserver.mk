...
LIBADSERVERCONNECTOR_LINK := \
	zeromq boost_thread utils endpoint services rtb gc bid_request
...
$(eval $(call library,standard_adserver,standard_adserver_connector.cc standard_win_source.cc standard_event_source.cc,adserver_connector bid_test_utils hiredis))
